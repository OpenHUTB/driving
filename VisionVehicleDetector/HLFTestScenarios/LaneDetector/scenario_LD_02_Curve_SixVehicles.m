function [scenario,assessment] = scenario_LD_02_Curve_SixVehicles
% scenario_LD_02_Curve_SixVehicles creates a driving scenario that is
% compatible with LaneMarkerDetectorTestBench.slx. This test
...
% vehicle while other vehicles travel in adjacent lanes. 
%  

%   Copyright 2020-2021 The MathWorks, Inc.

%  Get driving scenario that is compatible with
%  LaneMarkerDetectorTestBench.slx
