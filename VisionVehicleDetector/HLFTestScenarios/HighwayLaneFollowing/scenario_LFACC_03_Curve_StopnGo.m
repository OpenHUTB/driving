function [scenario,assessment] = scenario_LFACC_03_Curve_StopnGo(nvp)
% scenario_LFACC_03_Curve_StopnGo creates a driving scenario that is
...
% vehicle while others travel in adjacent lanes. In open loop, there is an
% expected collision between ego vehicle and lead car.
%  
