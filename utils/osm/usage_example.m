...
osm_url = 'https://github.com/johnyf/openstreetmap/releases/download/v0.2.2/map.osm';
if ~exist(openstreetmap_filename, "file")
    websave(fullfile(tempdir, openstreetmap_filename), osm_url);
    addpath(tempdir);
end
